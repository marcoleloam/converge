...
required = {
    ...
    "tools/memory/index.mjs",
    "tools/memory/package.json",
    "tools/memory/package-lock.json",
    "tools/memory/LICENSE",
...
assert len(skills) == 12, f"expected exactly twelve skills, got {len(skills)}: {skills}"
